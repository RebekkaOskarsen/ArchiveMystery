...
// Begin Class AMoldMinigame Function HideIngameTutorial
struct Z_Construct_UFunction_AMoldMinigame_HideIngameTutorial_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Mold/MoldMinigame.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMoldMinigame_HideIngameTutorial_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMoldMinigame, nullptr, "HideIngameTutorial", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMoldMinigame_HideIngameTutorial_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMoldMinigame_HideIngameTutorial_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AMoldMinigame_HideIngameTutorial()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMoldMinigame_HideIngameTutorial_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMoldMinigame::execHideIngameTutorial)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->HideIngameTutorial();
	P_NATIVE_END;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMoldMinigame_ResetMold_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMoldMinigame, nullptr, "ResetMold", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMoldMinigame_ResetMold_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMoldMinigame_ResetMold_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AMoldMinigame_ResetMold()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMoldMinigame_ResetMold_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMoldMinigame::execResetMold)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ResetMold();
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMoldMinigame_ShowIngameTutorial_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMoldMinigame, nullptr, "ShowIngameTutorial", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMoldMinigame_ShowIngameTutorial_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMoldMinigame_ShowIngameTutorial_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AMoldMinigame_ShowIngameTutorial()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMoldMinigame_ShowIngameTutorial_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMoldMinigame::execShowIngameTutorial)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class AMoldMinigame Function ShowIngameTutorial
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AMoldMinigame_Statics::NewProp_CurrentDifficulty = { "CurrentDifficulty", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMoldMinigame, CurrentDifficulty), Z_Construct_UEnum_ArchiveMystery_EMoldDifficulty, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurrentDifficulty_MetaData), NewProp_CurrentDifficulty_MetaData) }; // 1140100655
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AMoldMinigame_Statics::NewProp_IngameTutorialWidgetClass = { "IngameTutorialWidgetClass", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMoldMinigame, IngameTutorialWidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IngameTutorialWidgetClass_MetaData), NewProp_IngameTutorialWidgetClass_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMoldMinigame_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMoldMinigame_Statics::NewProp_IngameTutorialWidgetClass,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_henri_Downloads_fredag_ArchiveMystery_Source_ArchiveMystery_Public_Mold_MoldMinigame_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMoldMinigame, AMoldMinigame::StaticClass, TEXT("AMoldMinigame"), &Z_Registration_Info_UClass_AMoldMinigame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMoldMinigame), 1793156683U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_henri_Downloads_fredag_ArchiveMystery_Source_ArchiveMystery_Public_Mold_MoldMinigame_h_2772020087(TEXT("/Script/ArchiveMystery"),
	Z_CompiledInDeferFile_FID_Users_henri_Downloads_fredag_ArchiveMystery_Source_ArchiveMystery_Public_Mold_MoldMinigame_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_henri_Downloads_fredag_ArchiveMystery_Source_ArchiveMystery_Public_Mold_MoldMinigame_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_henri_Downloads_fredag_ArchiveMystery_Source_ArchiveMystery_Public_Mold_MoldMinigame_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_henri_Downloads_fredag_ArchiveMystery_Source_ArchiveMystery_Public_Mold_MoldMinigame_h_Statics::EnumInfo));
// End Registration
