...
// Begin Class AMold Function ResetMold
struct Z_Construct_UFunction_AMold_ResetMold_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMold_ResetMold_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMold, nullptr, "ResetMold", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMold_ResetMold_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMold_ResetMold_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AMold_ResetMold()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMold_ResetMold_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMold::execResetMold)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ResetMold();
...
// End Class AMold Function ResetMold

// Begin Class AMold
void AMold::StaticRegisterNativesAMold()
{
	UClass* Class = AMold::StaticClass();
	static const FNameNativePtrPair Funcs[] = {
		{ "ResetMold", &AMold::execResetMold },
	};
...
struct Z_Construct_UClass_AMold_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMold_ResetMold, "ResetMold" }, // 3267254918
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMold, AMold::StaticClass, TEXT("AMold"), &Z_Registration_Info_UClass_AMold, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMold), 985109650U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_2153635396(TEXT("/Script/ArchiveMystery"),
	Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::EnumInfo));
// End Registration
