...
struct Z_Construct_UClass_AMold_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MoldHealth_MetaData[] = {
		...
		{ "Comment", "// Health values exposed to the editor\n" },
#endif
		{ "ModuleRelativePath", "Public/Mold/Mold.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Health values exposed to the editor" },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PaperIndex_MetaData[] = {
		{ "Category", "Mold" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Stores which paper this mold belongs to (1 or 2)\n" },
#endif
		{ "ModuleRelativePath", "Public/Mold/Mold.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Stores which paper this mold belongs to (1 or 2)" },
#endif
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AMold_Statics::NewProp_PaperIndex = { "PaperIndex", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMold, PaperIndex), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PaperIndex_MetaData), NewProp_PaperIndex_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_GitHub_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMold, AMold::StaticClass, TEXT("AMold"), &Z_Registration_Info_UClass_AMold, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMold), 1865106418U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_GitHub_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_3823907666(TEXT("/Script/ArchiveMystery"),
	Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_GitHub_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_GitHub_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_GitHub_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_GitHub_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Mold_Mold_h_Statics::EnumInfo));
// End Registration
