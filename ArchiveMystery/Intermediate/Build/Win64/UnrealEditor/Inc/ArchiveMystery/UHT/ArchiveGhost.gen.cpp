...
// Begin Class AArchiveGhost Function GetCurrentTargetIndex
struct Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics
{
	struct ArchiveGhost_eventGetCurrentTargetIndex_Parms
	{
		int32 ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ArchiveGhost_eventGetCurrentTargetIndex_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AArchiveGhost, nullptr, "GetCurrentTargetIndex", nullptr, nullptr, Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::ArchiveGhost_eventGetCurrentTargetIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::ArchiveGhost_eventGetCurrentTargetIndex_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AArchiveGhost::execGetCurrentTargetIndex)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(int32*)Z_Param__Result=P_THIS->GetCurrentTargetIndex();
	P_NATIVE_END;
}
// End Class AArchiveGhost Function GetCurrentTargetIndex
...
// Begin Class AArchiveGhost Function SetCurrentTargetIndex
struct Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics
{
	struct ArchiveGhost_eventSetCurrentTargetIndex_Parms
	{
		int32 NewIndex;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::NewProp_NewIndex = { "NewIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ArchiveGhost_eventSetCurrentTargetIndex_Parms, NewIndex), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::NewProp_NewIndex,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AArchiveGhost, nullptr, "SetCurrentTargetIndex", nullptr, nullptr, Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::ArchiveGhost_eventSetCurrentTargetIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::ArchiveGhost_eventSetCurrentTargetIndex_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AArchiveGhost::execSetCurrentTargetIndex)
{
	P_GET_PROPERTY(FIntProperty,Z_Param_NewIndex);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetCurrentTargetIndex(Z_Param_NewIndex);
	P_NATIVE_END;
}
// End Class AArchiveGhost Function SetCurrentTargetIndex
...
void AArchiveGhost::StaticRegisterNativesAArchiveGhost()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "GetCurrentTargetIndex", &AArchiveGhost::execGetCurrentTargetIndex },
		{ "OnPlayerEnter", &AArchiveGhost::execOnPlayerEnter },
		{ "OnPlayerExit", &AArchiveGhost::execOnPlayerExit },
		{ "SetCurrentTargetIndex", &AArchiveGhost::execSetCurrentTargetIndex },
	};
...
struct Z_Construct_UClass_AArchiveGhost_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AArchiveGhost_GetCurrentTargetIndex, "GetCurrentTargetIndex" }, // 2909470524
		...
		{ &Z_Construct_UFunction_AArchiveGhost_SetCurrentTargetIndex, "SetCurrentTargetIndex" }, // 3005461608
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_henri_Downloads_torsdag_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchiveGhost_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AArchiveGhost, AArchiveGhost::StaticClass, TEXT("AArchiveGhost"), &Z_Registration_Info_UClass_AArchiveGhost, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AArchiveGhost), 3044837690U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_henri_Downloads_torsdag_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchiveGhost_h_2819956049(TEXT("/Script/ArchiveMystery"),
	Z_CompiledInDeferFile_FID_Users_henri_Downloads_torsdag_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchiveGhost_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_henri_Downloads_torsdag_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchiveGhost_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
