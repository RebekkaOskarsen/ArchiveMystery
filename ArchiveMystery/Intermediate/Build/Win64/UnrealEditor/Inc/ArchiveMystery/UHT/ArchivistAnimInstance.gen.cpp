...
struct Z_Construct_UClass_UArchivistAnimInstance_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIsHoldingFolder_MetaData[] = {
		{ "Category", "Folder" },
		{ "ModuleRelativePath", "Public/Character/ArchivistAnimInstance.h" },
	};
#endif // WITH_METADATA
	...
	static void NewProp_bIsHoldingFolder_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bIsHoldingFolder;
...
void Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayOpenBook_SetBit(void* Obj)
{
	((UArchivistAnimInstance*)Obj)->bPlayOpenBook = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayOpenBook = { "bPlayOpenBook", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UArchivistAnimInstance), &Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayOpenBook_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bPlayOpenBook_MetaData), NewProp_bPlayOpenBook_MetaData) };
void Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayReadBook_SetBit(void* Obj)
{
	((UArchivistAnimInstance*)Obj)->bPlayReadBook = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayReadBook = { "bPlayReadBook", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UArchivistAnimInstance), &Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayReadBook_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bPlayReadBook_MetaData), NewProp_bPlayReadBook_MetaData) };
void Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bIsHoldingFolder_SetBit(void* Obj)
{
	((UArchivistAnimInstance*)Obj)->bIsHoldingFolder = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bIsHoldingFolder = { "bIsHoldingFolder", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UArchivistAnimInstance), &Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bIsHoldingFolder_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsHoldingFolder_MetaData), NewProp_bIsHoldingFolder_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UArchivistAnimInstance_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayOpenBook,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bPlayReadBook,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArchivistAnimInstance_Statics::NewProp_bIsHoldingFolder,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchivistAnimInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UArchivistAnimInstance, UArchivistAnimInstance::StaticClass, TEXT("UArchivistAnimInstance"), &Z_Registration_Info_UClass_UArchivistAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UArchivistAnimInstance), 2798773246U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchivistAnimInstance_h_2709019280(TEXT("/Script/ArchiveMystery"),
	Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchivistAnimInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Bachelor_Project_ArchiveMystery_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchivistAnimInstance_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
