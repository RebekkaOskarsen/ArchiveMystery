...
struct Z_Construct_UClass_UArchiveGameInstance_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bHasGarageKeycard_MetaData[] = {
		{ "Category", "Keycards" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Doors & keycards \n" },
#endif
		{ "ModuleRelativePath", "Public/Character/ArchiveGameInstance.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Doors & keycards" },
#endif
	};
...
struct Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_saturday_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchiveGameInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UArchiveGameInstance, UArchiveGameInstance::StaticClass, TEXT("UArchiveGameInstance"), &Z_Registration_Info_UClass_UArchiveGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UArchiveGameInstance), 1284498651U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_henri_OneDrive___Universitetet_i_Innlandet_Skrivebord_saturday_ArchiveMystery_Source_ArchiveMystery_Public_Character_ArchiveGameInstance_h_2056976393(TEXT("/Script/ArchiveMystery"),
